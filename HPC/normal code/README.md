...
IF CODE NOT RUNNING, its because compiler doesnt support OpenMP. Instead of installing C++, do it on online compiler. Use this one as you can set it up to support openmp: https://www.onlinegdb.com/online_c++_compiler
